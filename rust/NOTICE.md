...
This Rust implementation is derived from KindleTool 1.6.6 and remains licensed under
...
The C implementation in the repository root is intentionally retained as the frozen
